...
// JpaRepository<Dossier, Long>: يحدد أن هذا المستودع يدير كيانات Dossier
...
public interface DossierRepository extends JpaRepository<Dossier, Long> {
    ...
    // طريقة للبحث عن الملفات باستخدام معرف العميل
    List<Dossier> findByClientIdClient(Long clientId);

    // طريقة للبحث عن الملفات باستخدام معرف العميل والحالة
    List<Dossier> findByClientIdClientAndStatut(Long clientId, String statut);
