...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth // السماح بالوصول العام لنقاط نهاية المصادقة
                        ...
                        .requestMatchers("/api/avocat/**").hasAnyRole(
                                Role.ADMINISTRATEUR.name(), Role.AVOCAT.name())
                        ...
                        .requestMatchers("/api/sessions/**").hasAnyRole(
                                Role.ADMINISTRATEUR.name(), Role.AVOCAT.name(), Role.ASSISTANT_JURIDIQUE.name())
                        .requestMatchers("/api/users/**").hasRole(Role.ADMINISTRATEUR.name())
                ...
                .exceptionHandling(exceptions -> exceptions
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            response.setContentType("application/json");
                            response.getWriter()
                                    .write("{\"error\": \"عذرا، ليس لديك الصلاحية للوصول إلى هذا المورد\"}");
                        }));
