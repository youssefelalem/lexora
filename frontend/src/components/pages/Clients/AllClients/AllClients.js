          ...
          <tbody className="bg-white">
            {filteredClients.map(client => (
              <tr key={client.id} className="text-sm text-gray-700 hover:bg-gray-50">
                ...
                <td className="px-4 py-3 border-b border-gray-200 dir-ltr text-left">{client.email}</td>
                <td className="px-4 py-3 border-b border-gray-200 dir-ltr text-left">{client.phone}</td>
                <td className="px-4 py-3 border-b border-gray-200 text-center">{client.cases}</td>
                <td className="px-4 py-3 border-b border-gray-200">
                  <span className={getStatusBadgeClass(client.status)}>
                    {client.status}
                  </span>
                </td>
                <td className="px-4 py-3 border-b border-gray-200">{client.created}</td>
